...
export const BloodDropSvg = () => {
    return (
        <svg height="100%" width="100%" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 460 460" xmlSpace="preserve">
            <g>
                <path style={{ fill: 'rgb(255, 146, 110)' }} d="M229.362,430c-37.114,0-72.041-14.43-98.346-40.632c-26.312-26.209-40.878-61.094-41.015-98.228
                ...
                <path style={{ fill: 'rgb(213, 49, 14)' }} d="M366.146,189.029C345.168,157.514,230,0,230,0v50.9c34.885,47.885,96.679,132.979,111.172,154.752
                ...
                <path style={{ fill: 'rgb(213, 49, 14)' }} d="M118.828,205.652c-19.502,29.298-28.931,57.262-28.827,85.488
                ...
                <polygon style={{ fill: 'rgb(244, 106, 26)' }} points="230,400 230,430 230.642,430 230.586,400" />
                <polygon style={{ fill: 'rgb(244, 106, 26)' }} points="230,89.394 230,370 230.529,370" />
                <path style={{ fill: 'rgb(128, 27, 6)' }} d="M230.529,370h0.113v30c-0.002,0-0.056,0-0.056,0l0.057,30c37.114,0,72.042-14.43,98.345-40.629
                    ...
                    L230.529,370z" />
                <path style={{ fill: 'rgb(255, 255, 255)' }} d="M230.639,400c0.002,0,0.002-30,0.002-30h-1.279c-43.599,0-79.201-35.476-79.362-79.082l-30,0.111
